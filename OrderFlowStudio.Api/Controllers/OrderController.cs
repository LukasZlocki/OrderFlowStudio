...
namespace OrderFlowStudio.Api.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        // READ
        [HttpGet("api/order/processingwaiting")]
        public ActionResult GetOrdersWithStatusProcessingWaiting()
        {
            var orders = _orderService.GetOrdersFilteredProcessingWaiting();
            var orderDto = OrderMapper.SerializeOrderToListOfOrderReadDto(orders);
            return Ok(orderDto);
        }
        ...
        // READ
        [HttpGet("api/order/correctionwaiting")]
        public ActionResult GetOrdersWithStatusCorrectionWaiting()
        {
            var orders = _orderService.GetOrdersFilteredCorrectionWaiting();
            var orderDto = OrderMapper.SerializeOrderToListOfOrderReadDto(orders);
            return Ok(orderDto);
        }
